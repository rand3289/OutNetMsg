...
DEPS = config.h state.h outnet.h lib/buffer.h lib/sock.h lib/client.h lib/sign.h lib/tweetnacl.h lib/json.hpp
OBJ = main.o webs.o config.o state.o outnet.o lib/sock.o lib/client.o lib/sign.o lib/tweetnacl.o
